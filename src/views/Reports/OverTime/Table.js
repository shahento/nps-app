	...
	const updatedColumns = [
...

		{
			...
			cell: (row) => (
				...
				>
					{row.promoters && row.promoters}
				</a>
			),
			selector: (row) => row.promoters && row.promoters,
		},
		{
			name: 'passive',
			...
			cell: (row) => (
				...
				>
					{row.passive && row.passive}
				</a>
			),
			selector: (row) => row.passive && row.passive,
		},
		{
			name: 'detractor',
			...
			cell: (row) => (
				...
				>
					{row.detractor && row.detractor}
				</a>
			),
			selector: (row) => row.detractor && row.detractor,
		},
		{
			name: 'total',
